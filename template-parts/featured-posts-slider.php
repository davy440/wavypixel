...
<?php $number_of_posts = get_theme_mod('wavypixel_featured_posts_slider_number', 4);
$order = get_theme_mod('wavypixel_featured_posts_slider_order', 'DESC');
$category = get_theme_mod('wavypixel_featured_posts_slider_category');
...
if ($featured_post_slider->have_posts()) {
    ...
    while ($featured_post_slider->have_posts()) {
        ...
        echo '<span class="post-author">' . esc_html__('By', 'wavypixel') . ' ' . get_the_author() . '</span>';
