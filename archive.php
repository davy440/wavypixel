...
$title_setting = get_theme_mod('wavypixel_archive_title_enable', '1');
$layout_setting = get_theme_mod('wavypixel_archive_layout_choice', 'boxed');
$sidebar_setting = get_theme_mod('wavypixel_archive_sidebar_choice', 'right');
